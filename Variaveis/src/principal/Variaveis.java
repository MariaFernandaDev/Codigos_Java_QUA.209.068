...
public class Variaveis {
	...
	public static void main(String[] args) {
		...
		// com (int) ele converte o número excluindo a parte decimal
		...
		System.out.println("*********************");
		System.out.print("Meu nome é: " + nome + ". Tenho: " + idade + " anos.");
		System.out.print("Eu peso " + peso + " kg e minha altura é " + altura + " metros.");
	}
